...
def candidate(x):
    return render_template("single.html", name=get_candidate(x)["name"], position=get_candidate(x)["position"], picture=get_candidate(x)["picture"], skills=get_candidate(x)["skills"])
